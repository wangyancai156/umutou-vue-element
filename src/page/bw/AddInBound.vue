                ...
                <el-form ref="form" label-width="80px">
                    ...
                    <el-form-item label="货架">
                        <el-select v-model="WarehouseShelf.val" clearable placeholder="请选择货架" class="handle-select mr10" style="width:150px">
                            <el-option v-for="item in WarehouseShelf.data" :key="item.Id" :label="item.Name" :value="item.Id"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="入库原因">
                        <el-select v-model="InOutReason.val" clearable placeholder="请选择入库原因" class="handle-select mr10" style="width:150px">
                            <el-option v-for="item in InOutReason.data" :key="item.Id" :label="item.Description" :value="item.Id"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="产品">
                        <el-select v-model="Product.val" clearable placeholder="请选择产品" class="handle-select mr10" style="width:150px">
                            <el-option v-for="item in Product.data" :key="item.Id" :label="item.ChineseName" :value="item.Id"></el-option>
                        </el-select>
                    </el-form-item>
